...
CCapacity <- 'carrying capacity/o_taurus_carrying_capacity_wa_updated.tif'   # same as carrying_capacity_e.intermedius_per_gridcell_for_ca_model2.tif
ProbAdultSurvival <- 'prob survival/o_taurus_probability_of_survival_wa_updated.tif'

# should have the location and number of starting reproductive females (not the number of introduced individuals)
starting_colony_coords <- 'release data/o_taurus_by_six_months.csv'
...
EggToAdultSurvival <- 0.73      ### Table 2 Garcia-Gonzales and Simmons 2011
...
MaxNOffspring <- 188  #  For O. taurus, we assumed the mean number of 23.5 eggs/week (Table 1. Hunt & Simmons, 2002) 
